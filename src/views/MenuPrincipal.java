...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Pablo Boer © 2023");
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				//DONE: Preguntar si desea salir
				if(JOptionPane.showConfirmDialog(null, "Desea salir de la aplicación?", "Salir", JOptionPane.YES_NO_OPTION)==0){
					System.exit(0);	
				}
